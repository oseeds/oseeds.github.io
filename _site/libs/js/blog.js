...
$(function() {
    ...
    $("#contactForm input,#contactForm textarea").jqBootstrapValidation({
        ...
        submitSuccess: function($form, event) {
            ...
            $.ajax({
                url: "https://formspree.io/julien@o-seeds.com",
                method: "POST",
                data: {
                    name: name,
                    phone: phone,
                ...
                success: function() {
                    ...
                    $('#success > .alert-success')
                        .append("<strong>Votre message a été expédié. </strong>");
                    $('#success > .alert-success')
                        .append('</div>');
...
(function(d, s, id) {
    ...
    js.src = "//connect.facebook.net/fr_FR/sdk.js#xfbml=1&version=v2.58&appId=105078386623631";
...
!function(t){"use strict";t("a.page-scroll").bind("click",function(a){var o=t(this);t("html, body").stop().animate({scrollTop:t(o.attr("href")).offset().top-50},1250,"easeInOutExpo"),a.preventDefault()}),t("body").scrollspy({target:".navbar-fixed-top",offset:51}),t(".navbar-collapse ul li a").click(function(){t(".navbar-toggle:visible").click()}),t("#mainNav").affix({offset:{top:100}})}(jQuery);
 ...
 var $grid = $('.grid').masonry({itemSelector: '.grid-item',percentPosition: true,columnWidth: '.grid-sizer'});$grid.imagesLoaded().progress( function() {$grid.masonry();}); 
        ...
        $(".grid img").on("click", function() {$('#imagepreview').attr('src', $(this).attr('src'));var a=$(this).attr('alt');if(a==undefined){a=""};$('#myModalLabel').text(a);$('#imagemodal').modal('show');});
